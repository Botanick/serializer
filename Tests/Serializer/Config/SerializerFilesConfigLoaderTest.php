...
class SerializerFilesConfigLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$_unreadablePerms = fileperms(self::$_configDir . '/bad/unreadable.yml') & 0777;
        chmod(self::$_configDir . '/bad/unreadable.yml', 0000);
    }

    public static function tearDownAfterClass()
    {
        chmod(self::$_configDir . '/bad/unreadable.yml', self::$_unreadablePerms);
    }
    ...
    public function getConfigForWithoutCacheExceptionProvider()
    {
        ...
        return array(
            ...
            array($configDir . '/bad/unreadable.yml', sprintf('Unable to load config from "%s". File is not readable.', $configDir . '/bad/unreadable.yml')),
